...
function updateStatus() {
    ...
    fetchTimezoneInfo(timezoneCode).then(() => {
        const now = new Date();
        ...
        // Update the availability display with GMT/BST
        updateAvailability('BST'); // Always use GMT/BST for availability
